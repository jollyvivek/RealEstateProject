      ...
      <div className=' container mx-auto flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='w-full md:w-1/3'>
              ...
              <div className="flex gap-2 ">
                <input type="email" className='p-2 rounded bg-gray-800 text-gray-400 border border-gray-900 focus:outline-none w-full md:w-auto' name="" placeholder='Enter Your Email' />
                  <button className="py-2 px-4 rounded bg-blue-500 text-white">Subscribe</button>
              </div>
          </div>
      </div>
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
        Copyright 2025 © Jollyvivek. All Right Reserved.
      </div>
    </div>
  )
}
