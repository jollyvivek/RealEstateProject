        ...
        <div className='flex flex-wrap justify-center gap-8'>
          {testimonialsData.map((testimonial,index)=>(
            <div key={index} className='max-w-[320px] border shadow-lg rounded px-8 py-12 text-center'>
                ...
                <p className='text-gray-500 my-2 text-sm'>{testimonial.title}</p>
                <div className='flex justify-center gap-1 text-red-500 my-3'>{Array.from({length:testimonial.rating},(item,index)=>(
